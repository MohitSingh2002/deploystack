...
class ProjectModel extends Project {
  ProjectModel({required super.id, required super.name, required super.type, required super.port, required super.domain, required super.subdomain, required super.createdAt, super.gitHubProject,});
